      ...
      <main className="w-full max-w-6xl px-6 py-16 md:px-10 lg:px-0">
        <section className="grid gap-10 rounded-3xl border border-white/10 bg-card/60 p-10 shadow-[0_40px_160px_rgba(2,6,23,0.6)] lg:grid-cols-[1.25fr_0.85fr]">
          <div className="space-y-8">
            ...
            <p className="text-lg text-slate-200">
              NPAK Construction preserves every beloved WordPress page—now rebuilt on a faster Next.js platform with modern storytelling, AI-enhanced
              planning tools, and forms that deliver straight to npakmax@gmail.com.
            </p>
          ...
          <div className="relative rounded-2xl border border-white/10 bg-surface px-6 py-8">
            ...
            <div className="pt-32">
              ...
              <p className="mt-6 text-lg text-slate-200">
                “NPAK stands for Nurturing, Passion, Adaptability, and Knowledge. We carry the same values into every deck and roof we deliver across the GTA.”
              </p>
        ...
        <section className="mt-16 grid gap-6 rounded-3xl border border-white/10 bg-card/80 p-10 md:grid-cols-[1fr_1fr]">
          <div>
            ...
            <p className="mt-4 text-slate-300">
              Migrating to Next.js unlocked smarter tooling. Our crews now tap into computer vision, generative design, and predictive scheduling so your project
              launches with fewer site visits and cleaner timelines.
            </p>
          </div>
        ...
        <section className="mt-16 grid gap-6 rounded-3xl border border-white/10 bg-card/60 p-10 md:grid-cols-[0.8fr_1.2fr]">
          <div className="space-y-4">
            ...
            <p className="text-slate-300">
              Transparency doesn’t stop at construction. Here’s how we’re structuring the digital migration so Google, clients, and your neighbourhood all stay in
              sync.
            </p>
          </div>
          <div className="grid gap-4">
        ...
        <section className="mt-16 grid gap-10 rounded-3xl border border-white/10 bg-card/70 p-10 md:grid-cols-[0.9fr_1.1fr]">
          <div className="space-y-4">
            ...
            <p className="text-slate-300">
              The legacy WordPress form has been replaced with a reliable serverless handler wired directly to npakmax@gmail.com. Submit the form and we’ll
